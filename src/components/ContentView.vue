<template>
  <div class="main-navbar sticky bg-white">
            ...
            <div class="card-body p-0">
              <div class="blog-comments__item d-flex p-3">
                ...
                <div class="blog-comments__content">
                  ...
                  <p
                    class="m-0 my-1 mb-2 text-muted"
                  >Well, the way they make shows is, they make one show ...</p>
              ...
              <div class="blog-comments__item d-flex p-3">
                ...
                <div class="blog-comments__content">
                  ...
                  <p
                    class="m-0 my-1 mb-2 text-muted"
                  >After the avalanche, it took us a week to climb out. Now...</p>
                  <div class="blog-comments__actions">
                    <div class="btn-group btn-group-sm">
                      <button type="button" class="btn btn-white">
                        <span class="text-success">
              ...
              <div class="blog-comments__item d-flex p-3">
                ...
                <div class="blog-comments__content">
                  ...
                  <p
                    class="m-0 my-1 mb-2 text-muted"
                  >My money's in that office, right? If she start giving me...</p>
                  <div class="blog-comments__actions">
                    <div class="btn-group btn-group-sm">
                      <button type="button" class="btn btn-white">
                        <span class="text-success">
